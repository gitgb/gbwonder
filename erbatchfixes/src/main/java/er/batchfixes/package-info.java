/**
This ERBatchFixes framework allows you to have your application do batch jobs at startup time. These jobs
...
create a subclass of ERBatchFixesParent, which will then do whatever batch jobs/processing you want. 
...
ERMigrations is used to create the db table.
<p/>
...
# these migrations happen after main program initialization..
